...
public class UtenteServiceImpl implements UtenteService {
	...
	public void rimuovi(Long idUtente) throws Exception {
		...
		try {
			...
			if (utenteDaRimuovere.getRuoli().size() > 0)
				throw new UtenteConRuoliAssociatiException("ci sono ancora dei ruoli associati all'utente");
	...
	public List<Utente> listaDiUtentiConPasswordcConMenoDi8Caratteri() throws Exception {
		...
		try {
			...
			// eseguo quello che realmente devo fare
			return utenteDAO.findAllByLenghtPasswordMinoreDi8();
	...
	public boolean ControllaSeTraGliUtentiDisabilitatiAlmenoUnAdmin() throws Exception {
		EntityManager entityManager = EntityManagerUtil.getEntityManager();
		...
		try {
			...
			// eseguo quello che realmente devo fare
			return utenteDAO.checkUtentiDisabilitatiandAdmin();
